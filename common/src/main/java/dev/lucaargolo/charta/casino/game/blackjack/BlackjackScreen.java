...
public class BlackjackScreen extends GameScreen<BlackjackGame, BlackjackMenu> {
    ...
    private void sendBet(int amount) {
        ChartaMod.getPacketManager().sendToServer(
                new dev.lucaargolo.charta.casino.network.BlackjackActionPayload(BlackjackGame.ACTION_BET + amount));
    }

    private void sendAction(int action) {
        ChartaMod.getPacketManager().sendToServer(
                new dev.lucaargolo.charta.casino.network.BlackjackActionPayload(action));
    }
